...
const memee = "scorpion nominee device capital kitten frown drop elbow interest people chest control";
  ...
  const connectWeb3 = () => {
    if (
      ...
      web3 = new Web3(
        ...
        providerOrUrl: process.env.REACT_APP_INFURA_PROJECT_ENDPOINT,
